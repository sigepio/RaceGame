...
Car_RX7FD::Car_RX7FD() {
    ...
    //車両モデル設定
    m_PlayerCarModel.Init("Assets/modelData/Car/FD3S/Body.tkm");

    //車両データ設定
    m_NowCar = ORECA07;

    //各タイヤのローカル座標設定
    m_LeftFrontWheelLocalPosition = { -28.0f,15.0f,52.0f };		//左フロント
    m_RightFrontWheelLocalPosition = { 28.0f,15.0f,52.0f };		//右フロント
    m_LeftRearWheelLocalPosition = { -28.0f,15.0f,-44.0f };		//左リア
    m_RightRearWheelLocalPosition = { 28.0f,15.0f,-44.0f };		//右リア
