...
bool SilverStone::Start() {
	//メモリの確保
	m_groundModel = std::make_unique<ModelRender>();
	m_groundModel->Init("Assets/modelData/course/SilverStone/Ground.tkm", false);
	m_CollisionModel = std::make_unique<ModelRender>();
	m_CollisionModel->Init("Assets/modelData/course/SilverStone/CollisionObject.tkm", false);
	m_CollisionAlphaBlendModel = std::make_unique<ModelRender>();
	m_CollisionAlphaBlendModel->Init("Assets/modelData/course/SilverStone/CollisionObjectAlpha.tkm", false, AlphaBlendMode_Trans);
	...
	m_NonCollisionModel.Init("Assets/modelData/course/SilverStone/NonCollisionObject.tkm", false);
	m_NonCollisionAlphaBlendModel.Init("Assets/modelData/course/SilverStone/NonCollisionObjectAlpha.tkm", false, AlphaBlendMode_Trans);
	TreeModel.Init("Assets/modelData/course/SilverStone/Tree.tkm", false, AlphaBlendMode_Trans);
...
void SilverStone::Render(RenderContext& rc) {
